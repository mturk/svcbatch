...
goto doStressTest
rem
svcbatch create sservice /lb /rS /c sservice.exe /c "300 some /c options " /c "\"and quoted one\"" /B:OFF "fake script" "script argument"
rem
goto End
rem
:doStressTest
...
svcbatch create sservice /lb /w work
rem
goto End
rem
:doDelete
